...
#define CA_FILE                "/home/ec2-user/gaofang.weihavefun.com_ca.crt"
#define CLIENT_KEY             "/home/ec2-user/gaofang.weihavefun.com.key"
#define CLIENT_CERT            "/home/ec2-user/gaofang.weihavefun.com.cer"
...
int main(int argc, char **argv)
{
...
#if 0
    const char * cipher_list = "DHE-ECDSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES128-SHA256:AES128-GCM-SHA256:RC4:HIGH:!MD5:!aNULL:!EDH";
    ...
    /*加载客户端证书*/
    if (use_cert && SSL_CTX_use_certificate_file(ctx, CLIENT_CERT, SSL_FILETYPE_PEM) != 1) {
        SSL_CTX_free(ctx);
    ...
    /*验证私钥*/
    if (use_cert && SSL_CTX_check_private_key(ctx) != 1) {
        SSL_CTX_free(ctx);
